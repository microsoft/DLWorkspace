...
def launch_ps_dist_job(jobId):
	workerPodInfo = GetPod(" type=worker -l run="+jobId)
	psPodInfo = GetPod(" type=ps -l run="+jobId)
...
if __name__ == '__main__':
	...
	TEST_GET_SVC = False
	TEST_GET_LOG = False
	launch_ps_dist_job("d3477fc6-8389-4058-b666-fd306695d03d")
