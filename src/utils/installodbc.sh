...
sudo apt-get --no-install-recommends install -y g++-5
...
sudo apt-get --no-install-recommends install -y libssl1.0.0 
sudo apt-get --no-install-recommends install -y libgss3 
sudo ldconfig
