...
class TestQuota(unittest.TestCase):
    ...
    def test_calculate_vc_resources(self):
        ...
        cluster_avail = ClusterResource(params={
            "cpu": {
                "r1": 17,
                "r2": 2,
                "": 2,
    ...
    def test_gpu_accounting_idle_gpus_become_unscheduable_in_cs(self):
        ...
        vc_info = {
            "A": ClusterResource(params={
                "gpu": {"P40": 40}
            }),
            "B": ClusterResource(params={
                "gpu": {"P40": 40}
            }),
            "C": ClusterResource(params={
                "gpu": {"P40": 40}
            }),
        }
        ...
        cluster_total = ClusterResource(params={
            "gpu": {"P40": 120}
        })
        cluster_avail = ClusterResource(params={
            "gpu": {"P40": 29}
        ...
        result = quota.calculate_vc_resources(
            cluster_total,
            cluster_avail,
            cluster_unschedulable,
            vc_info,
    ...
    def test_gpu_accounting_real_case_in_cs(self):
        ...
        # has the same logic as pure GPU accounting.
        vc_info = {
            "platform": ClusterResource(params={
                "gpu": {"P40": 48}
            }),
            "relevance": ClusterResource(params={
                "gpu": {"P40": 200}
            }),
            "quantus": ClusterResource(params={
                "gpu": {"P40": 100}
            }),
            "AU": ClusterResource(params={
                "gpu": {"P40": 20}
            }),
        }
    ...
    def test_gpu_accounting_real_case2_in_cs(self):
        ...
        vc_info = {
            ...
            "relevance2": ClusterResource(params={
                "gpu": {"P40": 234}
            }),
            "relevance2-inf": ClusterResource(params={
                "gpu": {"P40": 40}
            }),
        }
