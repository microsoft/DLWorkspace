export const SUCCESSFULLYAPPROVED = "Successfully approved";
export const SUCCESSFULLYPAUSED = "Successfully paused";
export const SUCCESSFULLYRESUMED = "Successfully resumed";
