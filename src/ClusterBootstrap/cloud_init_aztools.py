...
def render_infra_and_nfs(complementary_file_name, config):
	...
	domain_mapping = {"regular":"%s.cloudapp.azure.com" % config["azure_cluster"]["azure_location"], 
	...
	cc["etcd_node_num"] = len([mv for mv in cc["machines"].values() if 'infra' in mv['role']])
...
Command:
	...
	parser.add_argument("--complementary",
		help="Specify complementary file name the number of infra nodes, default = ",
